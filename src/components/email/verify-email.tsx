			...
			<Body style={main}>
				...
				<Container style={container}>
					...
					<Section>
						...
						<Text style={text}>
							Welcome! Please confirm your email address to
							activate your Todolist account.
						</Text>
						<Button style={button} href={verifyUrl}>
							Verify email
						</Button>
						<Text style={text}>
							If you didn&apos;t create an account with this
							email, you can safely ignore this message.
						</Text>
						<Text style={text}>
							For your security, don&apos;t forward this email to
							anyone. See our Help Center for{" "}
							<Link
								style={anchor}
								href={`https://${baseUrl}/help/security`}
							>
								more security tips.
							</Link>
						</Text>
